...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/calculation.cyclo ./Core/Src/calculation.d ./Core/Src/calculation.o ./Core/Src/calculation.su ./Core/Src/main.cyclo ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/measuring.cyclo ./Core/Src/measuring.d ./Core/Src/measuring.o ./Core/Src/measuring.su ./Core/Src/menu.cyclo ./Core/Src/menu.d ./Core/Src/menu.o ./Core/Src/menu.su ./Core/Src/stm32f4xx_it.cyclo ./Core/Src/stm32f4xx_it.d ./Core/Src/stm32f4xx_it.o ./Core/Src/stm32f4xx_it.su ./Core/Src/system_stm32f4xx.cyclo ./Core/Src/system_stm32f4xx.d ./Core/Src/system_stm32f4xx.o ./Core/Src/system_stm32f4xx.su
