...
protected:
    ...
    touchgfx::TextAreaWithOneWildcard textArea_LH_5A_1P;
    touchgfx::TextArea textArea1_CURRENTL_1P_5A;
    touchgfx::TextAreaWithOneWildcard textArea_LH_1A_1P;
    ...
    touchgfx::TextAreaWithOneWildcard textAreaCal_LR2_5A_1P;
    touchgfx::TextArea textArea1_CURRENTR_1P_5A;
    touchgfx::ButtonWithIcon buttonWithIcon_RH1_1A_1P;
    touchgfx::TextAreaWithOneWildcard textAreaCal_LR1_1A_1P;
    ...
    touchgfx::TextAreaWithOneWildcard textAreaCal_LH2_5A_3P;
    touchgfx::ButtonWithIcon buttonWithIcon_LH2_5A_3P;
    touchgfx::TextArea textArea1_CURRENTL_3P_5A;
    touchgfx::TextAreaWithOneWildcard textAreaCal_LH1_1A_3P;
    ...
    touchgfx::TextAreaWithOneWildcard textAreaCal_LR2_5A_3P;
    touchgfx::TextArea textArea1_CURRENTR_3P_5A;
    touchgfx::TextAreaWithOneWildcard textAreaCal_LR1_1A_3P;
    ...
    static const uint16_t TEXTAREA_LH_5A_1P_SIZE = 10;
    touchgfx::Unicode::UnicodeChar textArea_LH_5A_1PBuffer[TEXTAREA_LH_5A_1P_SIZE];
    static const uint16_t TEXTAREA_LH_1A_1P_SIZE = 10;
    touchgfx::Unicode::UnicodeChar textArea_LH_1A_1PBuffer[TEXTAREA_LH_1A_1P_SIZE];
    static const uint16_t TEXTAREACAL_LR2_5A_1P_SIZE = 10;
    touchgfx::Unicode::UnicodeChar textAreaCal_LR2_5A_1PBuffer[TEXTAREACAL_LR2_5A_1P_SIZE];
    static const uint16_t TEXTAREACAL_LR1_1A_1P_SIZE = 10;
    touchgfx::Unicode::UnicodeChar textAreaCal_LR1_1A_1PBuffer[TEXTAREACAL_LR1_1A_1P_SIZE];
    static const uint16_t TEXTAREACAL_LH2_5A_3P_SIZE = 10;
    touchgfx::Unicode::UnicodeChar textAreaCal_LH2_5A_3PBuffer[TEXTAREACAL_LH2_5A_3P_SIZE];
    static const uint16_t TEXTAREACAL_LH1_1A_3P_SIZE = 10;
    touchgfx::Unicode::UnicodeChar textAreaCal_LH1_1A_3PBuffer[TEXTAREACAL_LH1_1A_3P_SIZE];
    static const uint16_t TEXTAREACAL_LR2_5A_3P_SIZE = 10;
    touchgfx::Unicode::UnicodeChar textAreaCal_LR2_5A_3PBuffer[TEXTAREACAL_LR2_5A_3P_SIZE];
    static const uint16_t TEXTAREACAL_LR1_1A_3P_SIZE = 10;
    touchgfx::Unicode::UnicodeChar textAreaCal_LR1_1A_3PBuffer[TEXTAREACAL_LR1_1A_3P_SIZE];
