...
Measurement_Single_DisplayViewBase::Measurement_Single_DisplayViewBase() :
    buttonCallback(this, &Measurement_Single_DisplayViewBase::buttonCallbackHandler)
{
...
void Measurement_Single_DisplayViewBase::setupScreen()
{

}

void Measurement_Single_DisplayViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
