...
void Main_MenuViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &buttonWithLabel1)
    {
        ...
        //Go to Measurement with no screen transition
        application().gotoMeasurementScreenNoTransition();
    }
    ...
    if (&src == &buttonWithLabel3)
    {
        ...
        //Go to Project_Info with no screen transition
        application().gotoProject_InfoScreenNoTransition();
    }
}
