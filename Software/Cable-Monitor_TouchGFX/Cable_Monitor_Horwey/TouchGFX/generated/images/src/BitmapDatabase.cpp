...
extern const unsigned char image_alternate_theme_images_widgets_togglebutton_medium_round_text_on_light[]; // BITMAP_ALTERNATE_THEME_IMAGES_WIDGETS_TOGGLEBUTTON_MEDIUM_ROUND_TEXT_ON_LIGHT_ID = 9, Size: 138x50 pixels
...
extern const unsigned char image_settings[]; // BITMAP_SETTINGS_ID = 13, Size: 36x36 pixels
...
const touchgfx::Bitmap::BitmapData bitmap_database[] = {
    ...
    { image_settings, 0, 36, 36, 15, 1, 6, ((uint8_t)touchgfx::Bitmap::ARGB8888) >> 3, 2, ((uint8_t)touchgfx::Bitmap::ARGB8888) & 0x7 },
