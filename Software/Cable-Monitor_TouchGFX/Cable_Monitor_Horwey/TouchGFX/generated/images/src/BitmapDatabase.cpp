...
extern const unsigned char image_background_2_resized_4[]; // BITMAP_BACKGROUND_2_RESIZED_4_ID = 8, Size: 240x320 pixels
extern const unsigned char image_checkmark[]; // BITMAP_CHECKMARK_ID = 9, Size: 36x36 pixels
