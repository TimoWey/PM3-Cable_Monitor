...
extern const unsigned char image_alternate_theme_images_widgets_gauge_tiny_backgrounds_dark[]; // BITMAP_ALTERNATE_THEME_IMAGES_WIDGETS_GAUGE_TINY_BACKGROUNDS_DARK_ID = 6, Size: 120x120 pixels
extern const unsigned char image_alternate_theme_images_widgets_gauge_tiny_backgrounds_light_precision[]; // BITMAP_ALTERNATE_THEME_IMAGES_WIDGETS_GAUGE_TINY_BACKGROUNDS_LIGHT_PRECISION_ID = 7, Size: 120x120 pixels
...
extern const unsigned char image_background_2_resized[]; // BITMAP_BACKGROUND_2_RESIZED_ID = 9, Size: 240x320 pixels
extern const unsigned char image_background_2_resized_2[]; // BITMAP_BACKGROUND_2_RESIZED_2_ID = 10, Size: 240x320 pixels
extern const unsigned char image_background_2_resized_3[]; // BITMAP_BACKGROUND_2_RESIZED_3_ID = 11, Size: 240x320 pixels
extern const unsigned char image_background_2_resized_4[]; // BITMAP_BACKGROUND_2_RESIZED_4_ID = 12, Size: 240x320 pixels
extern const unsigned char image_power_off_36x36[]; // BITMAP_POWER_OFF_36X36_ID = 13, Size: 36x36 pixels
extern const unsigned char image_shutdown[]; // BITMAP_SHUTDOWN_ID = 14, Size: 247x320 pixels
extern const unsigned char image_v617batch2_bb_01_technology[]; // BITMAP_V617BATCH2_BB_01_TECHNOLOGY_ID = 15, Size: 240x320 pixels
...
const touchgfx::Bitmap::BitmapData bitmap_database[] = {
    ...
    { image_alternate_theme_images_widgets_gauge_tiny_backgrounds_light_precision, 0, 120, 120, 18, 17, 84, ((uint8_t)touchgfx::Bitmap::ARGB8888) >> 3, 86, ((uint8_t)touchgfx::Bitmap::ARGB8888) & 0x7 },
